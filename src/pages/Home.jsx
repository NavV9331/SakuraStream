...
import { Play, Globe, Activity, LayoutGrid, Tv, Music, Palette, Headphones, Download } from 'lucide-react';
import Aurora from '../components/Aurora';
import './Home.css';

const WebHome = ({ navigate }) => (
    <>
        ...
        <section className="hero-section">
            <div className="hero-content">
                ...
                <div className="hero-actions">
                    ...
                    <button className="btn-hero-secondary" onClick={() => navigate('/vod')}>
                        <Tv size={22} />
                        Movies & Shows
                    </button>
                    ...
                    <a className="btn-hero-secondary" href="SakuraStream-Setup-1.0.0.exe" download="SakuraStream-Setup-1.0.0.exe" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <Download size={22} />
                        Download App
                    </a>
                </div>
        ...
        <section className="features-section">
            <div className="features-bento">
                ...
                <div className="feature-card glass-panel bento-wide" style={{ cursor: 'pointer' }} onClick={() => navigate('/vod')}>
                    <div className="feature-icon-wrapper">
                        <Play size={32} />
                    </div>
                    <div className="bento-text">
                ...
                <div className="feature-card glass-panel bento-tall bento-accent" style={{ position: 'relative', overflow: 'hidden', cursor: 'pointer' }} onClick={() => navigate('/music')}>
